...
class Tbapplication(models.Model):
    ap_number = models.CharField(db_column='AP_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class Tbcompany(models.Model):
    com_number = models.CharField(db_column='Com_Number', primary_key=True, max_length=10)  # Field name made lowercase.
    ...
    com_leader = models.CharField(db_column='Com_Leader', max_length=20)  # Field name made lowercase.
    e_mail = models.CharField(db_column='E_mail', max_length=60, blank=True, null=True)  # Field name made lowercase.
    com_address = models.CharField(db_column='Com_Address', max_length=60)  # Field name made lowercase.
...
class TbfeedbackEr(models.Model):
    fbe_number = models.CharField(db_column='Fbe_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class TbfeedbackStu(models.Model):
    fbs_number = models.CharField(db_column='Fbs_Number', primary_key=True, max_length=10)  # Field name made lowercase.
    fb_content = models.CharField(db_column='Fb_Content', max_length=200, blank=True, null=True)  # Field name made lowercase.
    fb_time = models.DateTimeField(db_column='Fb_Time')  # Field name made lowercase.
...
class TbinResult(models.Model):
    inr_number = models.CharField(db_column='Inr_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class TbinWork(models.Model):
    iw_number = models.CharField(db_column='IW_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class TbinterviewApply(models.Model):
    ia_number = models.CharField(db_column='IA_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class TbinterviewNotice(models.Model):
    i_number = models.CharField(db_column='I_Number', primary_key=True, max_length=10)  # Field name made lowercase.
    ...
    ia_number = models.ForeignKey(TbinterviewApply, models.DO_NOTHING, db_column='IA_Number')  # Field name made lowercase.
    stu = models.ForeignKey('Tbstudent', models.DO_NOTHING, db_column='Stu_ID')  # Field name made lowercase.
...
class TbinterviewResult(models.Model):
    ir_number = models.CharField(db_column='IR_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class TboutWork(models.Model):
    ow_number = models.CharField(db_column='Ow_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class Tbqualify(models.Model):
    com_license = models.CharField(db_column='Com_License', primary_key=True, max_length=20)  # Field name made lowercase.
...
class Tbquery(models.Model):
    q_number = models.CharField(db_column='Q_Number', primary_key=True, max_length=10)  # Field name made lowercase.
...
class Tbresume(models.Model):
    res_id = models.CharField(db_column='Res_ID', primary_key=True, max_length=10)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=20)  # Field name made lowercase.
...
class Tbstudent(models.Model):
    ...
    name = models.CharField(db_column='Name', max_length=20)  # Field name made lowercase.
    pov_identity = models.CharField(db_column='Pov_Identity', max_length=2)  # Field name made lowercase.
    phonenumber_phonenumberphonenumber_phonenumber = models.CharField(db_column='PhoneNumber\r\nPhoneNumberPhoneNumber\r\nPhoneNumber', max_length=12)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    password = models.CharField(db_column='Password', max_length=20)  # Field name made lowercase.
    nickname = models.CharField(db_column='Nickname', max_length=20)  # Field name made lowercase.
    sex = models.CharField(db_column='Sex', max_length=2)  # Field name made lowercase.
    age = models.IntegerField(db_column='Age')  # Field name made lowercase.
    e_mail = models.CharField(db_column='E_mail', max_length=60, blank=True, null=True)  # Field name made lowercase.
    school = models.CharField(db_column='School', max_length=60)  # Field name made lowercase.
    ...
    res = models.ForeignKey(Tbresume, models.DO_NOTHING, db_column='Res_ID')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'tbstudent'
        unique_together = (('stu_id', 'school'),)
